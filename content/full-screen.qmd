...
<fieldset>
    ...
    <label><input type="radio" name="layerType" value="counties"> Counties</label>
    ...
    <label><input type="radio" name="layerType" value="parkruns"> Park Runs</label>
    <label><input type="radio" name="layerType" value="all" checked> All Layers</label>
    </fieldset>      
</div>
